Shader "Hidden/CellShading"
{
       ...
       */ 
       Properties
       {
           ...
           _HalfShadowThreshold ("Half Shadow Threshold", Range(0.0,1.0)) = 0.3
           _FullShadowThreshold ("Full Shadow Threshold", Range(-1.0,1.0)) = 0.01
           _ShadowAttenuationThreshold ("Shadow Attenuation Threshold", Range(0.0,1.0)) = 0.5
       }
           ...
           */
           ...
           Pass
           {
               ...
               */
               ...
               #pragma multi_compile _ _SHADOWS_SOFT_HIGH
